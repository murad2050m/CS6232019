...
public class Group3AcidDemo1 {
	...
	public static void main(String args[]) throws SQLException, IOException, ClassNotFoundException {
		...
		try {
			...
			//Update table without FOREIGN KEY CONSTRAINT
			stmt2.executeUpdate("UPDATE product SET prod_id='pp1' WHERE prod_id='p1'");
			//stmt2.executeUpdate("PROMPT FAILURE");
			stmt2.executeUpdate("UPDATE stock SET prod_id='pp1' WHERE prod_id='p1'");
